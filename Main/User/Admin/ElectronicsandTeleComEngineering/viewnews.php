                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-md-6 mb-4" disabled>
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                     <label class="form-check-label" for="materialChecked" style="color: darkred;font-size: 22px;">Teacher Board:</label>
                                     <hr>
                         <?php
                         $user ='root';
                         $pass = '';
                            ...
                            ?>
                                <div class="form-group row">
                                    <div class="col-md-12 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;"><i><b style="color: red"> New:</b></i>&nbsp;&nbsp;&nbsp;<?php echo $data['ANews_Date']?>:<?php echo $data['ANews_Short']?>:-<?php echo $data['ANews_Long']?><?php echo'<a href="deletenews.php?rn='.$data["ANews_Id"].'"><button class="btn btn-danger btn-sm">Delete</button></a></td>'?></label>
                                    </div>
                                <hr>
                          </div>
                          <?php }?>
