                ...
                <!-- Begin Page Content -->
                 ...
                 <div class="container">
                    ...
                    <div class="row0">
                      <div class="col-lg-12">
                          <div class="p-5">
                            <h2 class="h4 text-blue-900 mb-2" style="color: red; text-align: center;">Sending News Details..</h2>
                            <hr>
                            <form class="user" action="addnews.php" method="POST" enctype="multipart/form-data">

                                <div class="form-group row">
                                    <div class="col-md-4 mb-3 mb-sm-0">
                                          <div class="form-group">
                                        <label for="sel1" style="color: blue;"> Notice short Description :</label>
                                         <input type="text" name="short" class="form-control form-control-user" id="exampleLastName" required>
                                     </div>
                                   </div>

                                   <div class="col-md-8 mb-3 mb-sm-0">
                                          <div class="form-group">
                                     <label for="sel1" style="color: blue;">Long Description:</label>
                                      <input type="text" name="long" class="form-control form-control-user" id="exampleLastName" required>
...
{ 
    ...
    $dept='ElectronicsandTeleComEngineering'; 
       ...
       $sql='INSERT INTO adminnews VALUES("","'.$dept.'","'.$date.'","'.$short.'","'.$long.'")';

    if (mysqli_query($db,$sql))
     {
      echo "<script>
      alert('Hi Admin,News Send Successfully');
