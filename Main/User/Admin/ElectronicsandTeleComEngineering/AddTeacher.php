        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                                     <h1 class="h4 text-blue-900 mb-4" style="color: blue; text-align: center;">Add Teacher</h1>
                            <hr>
                            <form class="user" action="AddTeacher.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" name="mothername" class="form-control form-control-user" id="exampleLastName" required>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                        ...
                                        <input type="number" name="adhr" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                    <div class="col-sm-3">
...
if(isset($_POST['upload']))
{
    ...
    $Department="ElectronicsandTeleComEngineering";
    $date=$_POST['date'];
    $Gender=$_POST['Gender'];
    $address=$_POST['address'];

    $target = "../Teacher/".basename($_FILES['image']['name']);

      $image= $_FILES['image']['name'];
     if (move_uploaded_file($_FILES['image']['tmp_name'], $target))
    {
       $sql='INSERT INTO teacher VALUES("","'.$fullname.'","'.$mothername.'","'.$email.'","'.$number.'","'.$Gender.'","'.$date.'","'.$adhr.'","'.$Department.'","'.$password.'","'.$address.'","'.$image.'")';

    if (mysqli_query($db,$sql))
     {
      echo "<script>
          alert('Hi Admin, Teacher Added Successfully...');
