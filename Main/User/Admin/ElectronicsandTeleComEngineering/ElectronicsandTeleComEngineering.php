...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item active">
                <a class="nav-link" href="ElectronicsandTeleComEngineering">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 style="text-align:center;color: blue;">Welcome To ElectronicsandTeleCommunication Engineering Department.. </h5>
                    <hr>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                    $dept='ElectronicsandTeleComEngineering';
                         $name='Awad Deepak Fulchand';
                   ...
                   $data=mysqli_num_rows($result);
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Teacher_Dept FROM teacher WHERE Teacher_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT ANews_Dept FROM adminnews WHERE ANews_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                   ...
                   <?php
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Test_Dept FROM testquestion WHERE Test_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Student_Dept FROM history WHERE Student_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Query_Dept FROM query WHERE Query_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Reply_Dept FROM replyquery WHERE Reply_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2" style="text-align:center;">
                                            <div class="h5 mb-2 font-weight-bold text-gray-800"><?php echo $data;?></div>
                                              <div class="text-xl font-weight-bold text-primary text-uppercase mb-0">
                                                 Total Students Sorted Queries</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT TQuery_Dept FROM tquery WHERE TQuery_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Reply_Dept1 FROM replyteacher WHERE Reply_Dept1='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2" style="text-align:center;">
                                            <div class="h5 mb-2 font-weight-bold text-gray-800"><?php echo $data;?></div>
                                              <div class="text-xl font-weight-bold text-primary text-uppercase mb-0">
                                                 Total Teachers Sorted Queries</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
