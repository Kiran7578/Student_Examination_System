                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-md-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="col-sm-8 mb-3 mb-sm-0">
                                          <label for="sel1" style="color: blue;">Providing News:</label>
...
{ 
    ...
    $_SESSION['eid']=$eid; 
       ...
       $sql='INSERT INTO news VALUES("","'.$teachername.'","'.$class.'","'.$Semester.'","'.$dept.'","'.$date.'","'.$content.'")';

    if (mysqli_query($db,$sql))
     {
      echo "<script>
      alert('Hi Teacher, Exam News Created');
