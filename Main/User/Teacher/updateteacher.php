        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                                     <h1 class="h4 text-blue-900 mb-4" style="color: blue; text-align: center;">Update Student</h1>
                            <hr>
                            <form class="user" action="updateteacher.php" method="GET" enctype="multipart/form-data">
            
                                <div class="form-group row">
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked">Your Id:</label>
                                        <input type="text" name="id" value="<?php echo $id;?>" class="form-control form-control-user" id="exampleFirstName">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="form-check-label" for="materialChecked">Full Name:</label>
                                        <input type="text" name="name" value="<?php echo $data['Student_Name'];?>" class="form-control form-control-user" id="exampleFirstName"  required>
                                        
                                    </div>
                                    <div class="col-sm-3">
                                         <label class="form-check-label" for="materialChecked">Mobile Number:</label>
                                        <input type="text" name="number" value="<?php echo $data['Student_Number'];?>" class="form-control form-control-user" id="exampleLastName" required>
                                        
                                    </div>
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked">Email Id:</label>
                                        <input type="text" name="email" value="<?php echo $data['Student_Email'];?>" class="form-control form-control-user" id="exampleLastName" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                       ...
                                       <select class="form-control input-group input-group-lg" name="year" id="class1"  style="border-radius: 100px;" required onchange="populate(this.id,'Semester1')">
                                       <option value="" selected="selected">Select Class</option>
                                        <option value="FirstYear"
                                        <?php
                                        if ($data['Student_Class']=='FirstYear')
                                         {
                                            echo "selected";
                                        }
                                        ?>
                                       ...
                                       <?php
                                        if ($data['Student_Class']=='SecondYear')
                                         {
                                            echo "selected";
                                        }
                                        ?>
                                       ...
                                       <?php
                                        if ($data['Student_Class']=='ThirdYear')
                                         {
                                            echo "selected";
                                        }
                                        ?>>Third Year</option>
                                       ...
                                       <?php
                                        if ($data['Student_Class']=='FinalYear')
                                         {
                                            echo "selected";
                                        }
                                        ?>
                                    ...
                                    <div class="col-sm-3">
                                     ...
                                     <select class="form-control input-group input-group-lg" name="Semester" id="Semester1" style="border-radius: 100px;" required>
                                         <option value="<?php echo $data['Student_Semester']?>" selected="selected"><?php echo $data['Student_Semester']?></option>
                                     </select>
                                    </div>
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                   ...
                                   <div class="col-sm-3 mb-3 mb-sm-0">
                                        ...
                                        <input type="date" name="date" value="<?php echo $data['Student_Dob'];?>" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                  </div>
                                ...
                                <div class="form-group row">
                                     <div class="col-sm-3 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" name="password" value="<?php echo $data['Student_Password'];?>" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                    <div class="col-sm-9 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked">Permanent Address:</label>
                                        <input type="text" name="address" value="<?php echo $data['Student_Address'];?>" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                </div>
...
if(isset($_GET['upload']))
{
    ...
    $Department=$data['Teacher_Dept'];
       ...
       $sql='UPDATE student SET Student_Id="$id",Student_Name="$name",Student_Email="$email",Student_Number="$number",Student_Password="$password",Student_Class="$Year",Student_Semester="$Semester",Student_Gender="$Gender",Student_Dob="$date",Student_Address="$address",Student_Dept="$Department" WHERE Student_Id="$id"';

    if (mysqli_query($db,$sql))
     {
      echo "<script>
          alert('Hi Teacher , Student Updated Successfully...');
           window.location.href='viewstudent.php'
           </script>";
    }else
    {
        echo "<script>
          alert('Hi Teacher, Kindely checK some issue');
           window.location.href='viewstudent.php'
           </script>";
    }
}
