            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <?php
                        ...
                        $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                        $rollno = $data['Teacher_Name'];
                        $dept = $data['Teacher_Dept'];
                        $number = $data['Teacher_Number'];

                        $sql="SELECT * FROM replyteacher WHERE Reply_Name1= '".$rollno."' AND Reply_Dept1 ='".$dept."' AND Reply_Number1='".$number."' ";
                        $result=(mysqli_query($db,$sql));
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <h5 class="m-0 font-weight-bold text-primary" style="text-align:center">Query Details</h5>
                                    <hr>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2" style="text-align:left;">
                                                <div class="h5 mb-2  font-weight-bold ">Query Exam: '.$data["Reply_Name1"].'</div>
                                        <div class="h5 mb-2  font-weight-bold ">Sub Description: '.$data["Reply_Sub1"].'</div>
                                            <div class="h5 mb-2  font-weight-bold ">Query Descrption: '.$data["Reply_Content1"].'</div>
                                            <div class="h5 mb-2  font-weight-bold " style="color:red">Co of Exam Message:<br>'.$data["Reply_msg1"].'</div>
