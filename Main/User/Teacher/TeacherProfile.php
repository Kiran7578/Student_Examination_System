                        ...
                        <div class="p-5">
                            <div class="form-group row">
                                    <div class="col-sm-3" style="margin-top:40px">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName" value="<?php echo $data['Teacher_Name'];?>" disabled>
                                        <br>
                                       <label class="form-check-label" for="materialChecked">Password:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $data['Teacher_Password'];?>" disabled>
                                        <br>
                                        <label class="form-check-label" for="materialChecked">Department:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $data['Teacher_Dept'];?>" disabled>
                                    </div>

                                    <div class="col-sm-3" style="margin-top:40px">
                                         <label class="form-check-label" for="materialChecked">Email Id:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $data['Teacher_Email'];?>" disabled>
                                        <br>
                                        <label class="form-check-label" for="materialChecked">Adhr Number:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $data['Teacher_Adhr'];?>" disabled>
                                        <br>
                                        <label class="form-check-label" for="materialChecked">Gender:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $data['Teacher_Gender'];?>" disabled>

                                        
                                    </div>
                                    <div class="col-sm-3" style="margin-top:40px">
                                         <label class="form-check-label" for="materialChecked">Mobile Number:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName" value="<?php echo $data['Teacher_Number'];?>" disabled>
                                        <br>
                                        <label class="form-check-label" for="materialChecked">Mother Name:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $data['Teacher_Mother'];?>" disabled>
                                        <br>
                                        <label class="form-check-label" for="materialChecked">Dob:</label>
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $data['Teacher_Dob'];?>" disabled>
                                        
                                    </div>
                                    <div class="col-sm-3">
                                         <label class="form-check-label" for="materialChecked">Image:</label>
                                   <?php echo'<img src="../Admin/Teacher/'.$data['Teacher_Image'].'" class="card-img-top z-depth-2" / style="height: 280px;">'?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName" value="<?php echo $data['Teacher_Address'];?>" disabled>
                                    </div>
                                </div>
                            </form>
