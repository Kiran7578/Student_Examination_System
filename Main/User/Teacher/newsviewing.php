            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        $sql="SELECT * FROM news WHERE News_Class= '".$rollno."' AND News_Dept ='".$dept."' AND News_Name ='".$name."' ORDER BY News_Date DESC ";
                        $result=(mysqli_query($db,$sql));
                            ...
                            ?>
                                <div class="form-group row">
                                    <div class="col-md-12 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;"><i><b style="color: red"> New:</b></i>&nbsp;&nbsp;&nbsp;<?php echo $data['News_Date']?>:<?php echo $data['News_Content']?><?php echo'<a href="deletenews.php?rn='.$data["News_Id"].'"><button class="btn btn-danger btn-sm">Delete</button></a></td>'?></label>
                                    </div>
                                <hr>
                          </div>
                          <?php }?>
                        ...
                        $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                        $sql="SELECT * FROM examlink WHERE Exam_Class= '".$rollno."' AND Exam_Dept ='".$dept."' AND Exam_CreateN ='".$name."' ORDER BY Exam_Date DESC ";
                        $result=(mysqli_query($db,$sql));
                        while($data=mysqli_fetch_assoc($result))
                        {
                            ?>
                                <div class="form-group row">
                                    <div class="col-md-12 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;"><i><b style="color: red"> New:</b></i>&nbsp;&nbsp;&nbsp;<?php echo $data['Exam_Date']?>:<a href="<?php echo $data['Exam_Link']?>" target="_blank"><?php echo $data['Exam_Link']?></a> :
                                            <?php echo $data['Exam_LinkD']?><?php echo'<a href="deletelink.php?rn='.$data["Exam_Id"].'"><br><button class="btn btn-danger btn-sm">Delete</button></a>'?>
                                         </label>
                                    </div>
                                <hr>
                          </div>
