            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <?php
                        ...
                        $sql="SELECT * FROM testquestion WHERE Test_Dept= '".$dept."' AND Test_Teacher='".$tname."' ";
                        $result=(mysqli_query($db,$sql));
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2" style="text-align:left;">
                                            ...
                                            <div class="col-md-4">
                                         <a href="viewteacherresult.php?rn='.$data['Test_Id'].'&fn='.$data['Test_Teacher'].'&gn='.$data['Test_Dept'].'&pn='.$data['Test_Class'].'"><button class="btn btn-success btn-sm">View Record</button></a>
                                            </div>
