            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="addexamlink.php">Add Exam Link</a>
                ...
                <div class="container-fluid">
                 ...
                 <div class="container">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                          <div class="p-5">
                            <h2 class="h4 text-blue-900 mb-2" style="color: red; text-align: center;">Sending Exam Link Details..</h2>
                            <hr>
                            <form class="user" action="addexamlink.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                          <label for="sel1" style="color: blue;">Providing Exam Link:</label>
                                        <input type="text" name="examlink" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                           <label for="sel1" style="color: blue;">Providing Link Decription:</label>
                                        <input type="text" name="content" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                </div>
...
{ 
    ...
    $_SESSION['eid']=$eid; 
       ...
       $sql='INSERT INTO examlink VALUES("","'.$teachername.'","'.$class.'","'.$Semester.'","'.$dept.'","'.$date.'","'.$examlink.'","'.$content.'")';

    if (mysqli_query($db,$sql))
     {
      echo "<script>
      alert('Hi Teacher, Check Exam Link Uploaded');
           window.location.href='addexamlink.php';
           </script>";
    }else
    {
        echo "<script>
