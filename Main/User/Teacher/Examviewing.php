                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <a href="quizquestion.php?q=quizquestion.php&eid='.$data['Test_Id'].'&total='.$data['Test_Questions'].'"><button class="btn btn-success btn-md" style="margin-left:40px">Take Test</button></a>
                                    <a href="deletequiz.php?eid='.$data["Test_Id"].'"><button class="btn btn-danger btn-md">Delete</button></a></td>
                                </div>
                            </div>
                        </div>';
                          }  ?>
