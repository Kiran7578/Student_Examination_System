            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM query WHERE Query_Year='FirstYear' AND Query_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Query_Year FROM query WHERE Query_Year='FirstYear' AND Query_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                     ...
                                     <?php
                                     echo'<a href="studentqueriesviewing.php?rn='.$data1["Query_Year"].' & fn='.$data1['Query_Dept'].' & gn='.$data1['Query_HeldName'].'"><button class="btn btn-success btn-md" style="margin-left:25%;margin-top:2%">View Queries</button></a>'?>
                                </div>
                            </div>
                        </div>
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM query WHERE Query_Year='SecondYear' AND Query_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Query_Year FROM query WHERE Query_Year='SecondYear' AND Query_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $sql="SELECT * FROM query WHERE Query_Year='ThirdYear' AND Query_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Query_Year FROM query WHERE Query_Year='ThirdYear' AND Query_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                     ...
                     $sql="SELECT * FROM query WHERE Query_Year='FinalYear' AND Query_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Query_Year FROM query WHERE Query_Year='FinalYear' AND Query_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
