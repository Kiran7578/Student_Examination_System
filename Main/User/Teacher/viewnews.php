            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM news WHERE News_Class='FirstYear' AND News_Dept='".$dept."' ";
                     $result=(mysqli_query($db,$sql));
                     $data2=mysqli_fetch_assoc($result);

                      $sql="SELECT News_Class FROM news WHERE News_Class='FirstYear' AND News_Dept='".$department."' ";
                     $result=(mysqli_query($db,$sql));
                     $data=mysqli_num_rows($result);

                     $sql="SELECT Exam_Class FROM examlink WHERE Exam_Class='FirstYear' AND Exam_Dept='".$department."' ";
                     $result=(mysqli_query($db,$sql));
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2" style="text-align:center;">
                                            <div class="h5 mb-2 font-weight-bold text-gray-800"><?php echo $data+$data1;?></div>
                                              <div class="text-xl font-weight-bold text-primary text-uppercase mb-0">
                                                 First Year</div>
                                        </div>
                                    </div>
                                     <?php
                                     echo'<a href="newsviewing.php?rn='.$data2["News_Class"].' & fn='.$data2['News_Dept'].'"><button class="btn btn-success btn-md" style="margin-left:6%;margin-top:2%">News(ExamLink) Viewing</button></a>'?>
                                </div>
                            </div>
                        </div>
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM news WHERE News_Class='SecondYear' AND News_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data2=mysqli_fetch_assoc($result);

                   $sql="SELECT News_Class FROM news WHERE News_Class='SecondYear' AND News_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);

                   $sql="SELECT Exam_Class FROM examlink WHERE Exam_Class='SecondYear' AND Exam_Dept='".$department."' ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_num_rows($result);
                    ?>
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM news WHERE News_Class='ThirdYear' AND News_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data2=mysqli_fetch_assoc($result);

                   $sql="SELECT News_Class FROM news WHERE News_Class='ThirdYear' AND News_Dept='".$department."' ";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);

                   $sql="SELECT Exam_Class FROM examlink WHERE Exam_Class='ThirdYear' AND Exam_Dept='".$department."' ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                     ...
                     $sql="SELECT * FROM news WHERE News_Class='FinalYear' AND News_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data2=mysqli_fetch_assoc($result);

                   $sql="SELECT News_Class FROM news WHERE News_Class='FinalYear' AND News_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);

                   $sql="SELECT Exam_Class FROM examlink WHERE Exam_Class='FinalYear' AND Exam_Dept='".$department."' ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_num_rows($result);
                    ?>
