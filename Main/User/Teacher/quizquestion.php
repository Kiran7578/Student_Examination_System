                 ...
                 <div class="container">
                    ...
                    $c=1;
                     while($row=mysqli_fetch_array($sql))
                     {
                       ...
                       echo' <form action="TestResult.php?qid='.$qid.'&eid='.$eid.'" method="POST">';
                      echo '<div class="card">
                   ...
                   echo'</div>
                       ...
                       echo'<hr><button type="submit" name="result" class="btn btn-success m-auto d-block">submit Exam</button>
                     </form> ';
