            ...
            <div class="col-xl-12 col-lg-12 col-md-10">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 "><img src="../../Files/img/Teacher.jpg" style="width: 100%;height: 100%;"></div>
                            <div class="col-lg-6"><br>
                                <div class="p-5">
                                    <div class="text-center"><br>
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Teacher Login</h1>
                                    </div>
                                    <form class="user" action="TeacherLogin.php" method="POST">
                                    ...
                                    <div class="text-center">
                                      ...
                                      <a class="small" href="forgetteacher.php">Forgot Password?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    if (mysqli_num_rows($result))
     {
      ...
      echo "<script>
          alert('Hi Teacher, Login Successfully...');
          window.location.href='Teacher.php'
           </script>";
    }else
    {
        echo "<script>
          alert('Hi Teacher, your Username and password is Invalid...');
