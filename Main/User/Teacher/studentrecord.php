            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                     ...
                     $sql="SELECT * FROM history WHERE Student_Class='FirstYear' AND Student_Dept='".$dept."' ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Student_Class FROM history WHERE Student_Class='FirstYear' AND Student_Dept='".$department."' ";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                     ...
                                     <?php
                                     echo'<a href="studentrecordviewing.php?rn='.$data1["Student_Class"].' & fn='.$data1['Student_Dept'].'"><button class="btn btn-success btn-md" style="margin-left:28%;margin-top:2%">View Record</button></a>'?>
                                </div>
                            </div>
                        </div>
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM history WHERE Student_Class='SecondYear' AND Student_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Student_Class FROM history WHERE Student_Class='SecondYear' AND Student_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM history WHERE Student_Class='ThirdYear' AND Student_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Student_Class FROM history WHERE Student_Class='ThirdYear' AND Student_Dept='".$department."' ";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                   ...
                   $sql="SELECT * FROM history WHERE Student_Class='FinalYear' AND Student_Dept='".$department."'  ";
                   $result=(mysqli_query($db,$sql));
                   $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Student_Class FROM history WHERE Student_Class='FinalYear' AND Student_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
