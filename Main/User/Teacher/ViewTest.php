            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                     ...
                     $sql="SELECT * FROM testquestion WHERE Test_Class='FirstYear' AND Test_Dept='".$department."' ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Test_Class FROM testquestion WHERE Test_Class='FirstYear' AND Test_Dept='".$department."' ";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                     ...
                                     <?php
                                     echo'<a href="Examviewing.php?rn='.$data1["Test_Class"].' & fn='.$data1['Test_Dept'].'"><button class="btn btn-success btn-md" style="margin-left:20%;margin-top:2%">View Exam Details</button></a>'?>
                                </div>
                            </div>
                        </div>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                     ...
                     $sql="SELECT * FROM testquestion WHERE Test_Class='SecondYear' AND Test_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Test_Class FROM testquestion WHERE Test_Class='SecondYear' AND Test_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $dept=$data['Teacher_Dept'];
                     ...
                     $sql="SELECT * FROM testquestion WHERE Test_Class='ThirdYear' AND Test_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Test_Class FROM testquestion WHERE Test_Class='ThirdYear' AND Test_Dept='".$department."' ";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                     ...
                     $sql="SELECT * FROM testquestion WHERE Test_Class='FinalYear' AND Test_Dept='".$department."'  ";
                     $result=(mysqli_query($db,$sql));
                     $data1=mysqli_fetch_assoc($result);

                   $sql="SELECT Test_Class FROM testquestion WHERE Test_Class='FinalYear' AND Test_Dept='".$department."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
