                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="forgetteacher.php" method="POST">
...
if(isset($_POST['submit']))
{
    ...
    $sql="SELECT * FROM teacher WHERE Teacher_Number='".$number."'";
    ...
    if (mysqli_num_rows($result))
     {
          ...
          $pass=$data['Teacher_Password'];
             ...
             $fields = array(
                 "message" => "Hi ".$name.". Your account passowrd is ".$pass.". Never Send to your password anyone. ",
                 "language" => "english",
                 "route" => "q",
                 "numbers" => "".$number."",
             );
        ...
        }else
        {
          ...
          alert('Mobile Number is not valid, Kindely check Number');
           window.location.href='forgetteacher.php'
           </script>";
        }
    }
