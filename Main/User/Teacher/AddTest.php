                ...
                <div class="container-fluid">
                 ...
                 <div class="container">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                          <div class="p-5">
                            <h2 class="h4 text-blue-900 mb-2" style="color: deeppink; text-align: center;">!! Adding of Test Details !!</h2>
                            <hr>
                            <form class="user" action="AddTest.php" method="POST" enctype="multipart/form-data">

                                <div class="form-group row">
                                    <div class="col-md-6 mb-3 mb-sm-0">
                                          <div class="form-group">
                                        <label for="sel1" style="color: blue;"> Select Year/Class of Students :</label>
                                   ...
                                   <div class="col-md-6 mb-3 mb-sm-0">
                                          <div class="form-group">
                                     <label for="sel1" style="color: blue;">Select Semester:</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;">Test Title:</label>
                                        <input type="text" name="testtitle" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                    <div class="col-md-6 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;">Test Questions:</label>
                                        <input type="text" name="testquestions" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                     <div class="col-md-6 mb-3 mb-sm-0">
                                        <label class="form-check-label" for="materialChecked" style="color: blue;">Marks For Each Question:</label>
                                        <input type="text" name="testmarks" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                    <div class="col-md-6 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;">Marks For Wrong Each Question:</label>
                                        <input type="text" name="testwrong" class="form-control form-control-user" id="exampleFirstName" required>
                                    </div>
                                </div>
...
if(isset($_POST['upload']))
{
    ...
    $testwrong=$_POST['testwrong'];
    $dept=$data['Teacher_Dept'];
    $teacher=$data['Teacher_Name'];
    $testquestions=$_POST['testquestions'];

     $eid=mt_rand(0000,9999);
    $_SESSION['eid']=$eid; 

       $sql='INSERT INTO testquestion VALUES("'.$eid.'","'.$class.'","'.$Semester.'","'.$testtitle.'","'.$testquestions.'","'.$testmarks.'","'.$testwrong.'","'.$date.'","'.$dept.'","'.$teacher.'")';

    if (mysqli_query($db,$sql))
     {
        $_SESSION['qns']= $testquestions;
        $_SESSION['qns1']= $testmarks;
        $_SESSION['qns2']= $testwrong;
      echo "<script>
