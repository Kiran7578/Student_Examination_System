        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                 ...
                 <div class="container">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                          <div class="p-5">
                            <h2 class="h5 text-blue-900 mb-2" style="color: deeppink; text-align: center;">Your Result:</h2>
                            <?php
                        $user='root';
                       $pass='';
                       $db='seminar';
               ...
               if(isset($_REQUEST['result']))
                {  
                 $eid=$_REQUEST['eid'];
                 $sq=mysqli_query($db,"select * from quizquestion where eid='$eid'");
                ...
                @$wrong=$attempt-$result;
                 ...
                 //insertion in history
                    ...
                    $studentdept=$data['Student_Dept'];
                    $studentclass=$data['Student_Class'];
                    $studentteacher=$_REQUEST['testteacher'];
               $chck="select * from history where username='$studentname' AND eid='$eid' ";
               $rslt=$db->query($chck);
               if($rslt->num_rows==0)
               {
                $sql="insert into history values ('','$studentname','".$data['Student_Email']."','".$data['Student_Number']."','$eid','0','0','0','0',now(),'".$studentclass."','".$studentdept."','$studentteacher')";
                mysqli_query($db,$sql);      
             }
              $ins="update history set totals='$n',correct='$result',wrong='$wrong',score='$tscore',date=now(),Test_Teacher='$studentteacher' where username='$studentname' AND eid='$eid' ";
               mysqli_query($db,$ins);
