            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <?php
                        ...
                        $sql="SELECT * FROM replyquery WHERE Reply_Year= '".$rollno."' AND Reply_Dept ='".$dept."' ";
                        $result=(mysqli_query($db,$sql));
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2" style="text-align:left;">
                                                <div class="h5 mb-2  font-weight-bold ">Query Exam: '.$data["Reply_Name"].'</div>
                                        <div class="h5 mb-2  font-weight-bold ">Co of Exam: '.$data["Reply_HeldName"].'</div>
                                            <div class="h5 mb-2  font-weight-bold ">Query Descrption: '.$data["Reply_Description"].'</div>
                                            <div class="h5 mb-2  font-weight-bold " style="color:red">Co of Exam Message:<br>'.$data["Reply_Message"].'</div>
