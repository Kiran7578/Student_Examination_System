        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 style="text-align:center;color: blue;">! ! Welcome To <?php echo $data['Student_Dept'];?> Department. Your Currently Pursuing  <?php echo $data['Student_Class'];?>! !
                </h5>
                    <hr>

                 <!-- Content Row -->
                    <div class="row">
                        <div class="col-xl-6 col-md-6 mb-4" disabled>
                      ...
                      <?php
                        ...
                        $sql="SELECT * FROM news WHERE News_Class= '".$rollno."' AND News_Dept ='".$dept."' ORDER BY News_Date DESC ";
                        $result=(mysqli_query($db,$sql));
                            ...
                            ?>
                                <div class="form-group row">
                                    <div class="col-md-12 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;"><i><b style="color: red"> New:</b></i>&nbsp;&nbsp;&nbsp;<?php echo $data['News_Date']?>:<?php echo $data['News_Content']?></label>
                                    </div>
                                <hr>
                          </div>
                          <?php }?>
                        ...
                        <div class="col-xl-6 col-md-6 mb-4" disabled>
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                     <label class="form-check-label" for="materialChecked" style="color: darkred;font-size: 22px;">Exam Board:</label>
                                     <hr>
                          <?php
                         $user ='root';
                         $pass = '';
                        ...
                        $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                        $sql="SELECT * FROM examlink WHERE Exam_Class= '".$rollno."' AND Exam_Dept ='".$dept."' ORDER BY Exam_Date DESC ";
                        $result=(mysqli_query($db,$sql));
                        while($data=mysqli_fetch_assoc($result))
                        {
                            ?>
                                <div class="form-group row">
                                    <div class="col-md-12 mb-3 mb-sm-0">
                                         <label class="form-check-label" for="materialChecked" style="color: blue;"><i><b style="color: red"> New:</b></i>&nbsp;&nbsp;&nbsp;<?php echo $data['Exam_Date']?>:<a href="<?php echo $data['Exam_Link']?>" target="_blank"><?php echo $data['Exam_Link']?></a> :
                                            <?php echo $data['Exam_LinkD']?>
                                         </label>
                                    </div>
                                <hr>
                          </div>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Query_Number,Query_Dept FROM query WHERE Query_Number='".$number."' AND Query_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Reply_Number,Reply_Dept FROM replyquery WHERE Reply_Number='".$number."' AND Reply_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT number,Student_Dept FROM history WHERE number='".$number."' AND Student_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
                    ...
                    $db = new mysqli('localhost',$user,$pass,$db) or die("unable to connect");
                   $sql="SELECT Test_Class,Test_Dept FROM testquestion WHERE Test_Class='".$rollno."' AND Test_Dept='".$dept."'";
                   $result=(mysqli_query($db,$sql));
                   $data=mysqli_num_rows($result);
                    ?>
