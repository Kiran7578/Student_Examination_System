                   ...
                   <?php
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <h5 class="m-0 font-weight-bold text-primary" style="text-align:center">Test Details</h5>
                                    <hr>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2" style="text-align:center;">
                                        <div class="h5 mb-2  font-weight-bold ">Co of Exam: '.$data["Test_Teacher"].'</div>
                                            <div class="h5 mb-2  font-weight-bold ">Name OF Exam: '.$data["Test_Title"].'</div>
                                            <div class="h5 mb-2  font-weight-bold ">No Of Questions: '.$data["Test_Questions"].'</div>
                                            <div class="h5 mb-2  font-weight-bold ">Corrective Marks: '.$data["Test_Marks"].'</div>
                                            <div class="h5 mb-2  font-weight-bold ">Negative Marks: '.$data["Test_Wrong"].'</div>
                                        
                                        </div>
                                    </div>
                                    <hr>
                                    <a href="quizquestion.php?q=quizquestion.php&eid='.$data['Test_Id'].'&total='.$data['Test_Questions'].'&teacher='.$data['Test_Teacher'].'"><button class="btn btn-success btn-md" function="back()" style="margin-left:34%">Take Test</button></a>
                                    </td>
                                </div>
                            </div>
                        </div>';
